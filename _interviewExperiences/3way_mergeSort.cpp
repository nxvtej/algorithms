...
class MergeSort{
public: void mergesort3way(vector<int>&array, int size){
	if(size == 0) return;
	vector<int> fArray;
	for(auto it: array) fArray.push_back(it);
...
private: void mergeSort3wayRecursion(vector<int>&fArray, int start, 
